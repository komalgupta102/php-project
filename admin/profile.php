					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							<div class="profile-photo">
								...
								<img src="vendors/images/product-img4.jpg" alt="" class="avatar-photo">
							...
							<h5 class="text-center h5 mb-0"><?php echo ($user_details) ? $user_details->name : ''; ?></h5>
							...
							<div class="profile-info">
								...
								<ul>
									<li>
										...
										<?php echo ($user_details) ? $user_details->email : ''; ?>
									</li>
									<li>
